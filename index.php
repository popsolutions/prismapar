...
<body>
  ...
  <main class="main">
          ...
          <div class="row d-md-none d-block timeline_mobile">
            ...
            <div class="owl-carousel owl-carousel2 owl-theme owl-loaded owl-drag">
              <div class="">
                ...
                <p> <?php echo _('Renato Souza Neto e Paulo Renato Souza, ex-ministro da Educação do Brasil, fundam a Prismapar em 2002
                  com foco em M&A no setor de Educação.');?> <br>
                </p>
              ...
              <div class="">
                ...
                <p> <?php echo _('Início do processo de internacionalização na América Latina com a abertura dos escritórios na Costa
                  Rica (2012), Colômbia (2015) e Equador (2018).');?> </p>
              ...
              <div>
                ...
                <p> <?php echo _('Com a incorporação de novos sócios e colaboradores, iniciamos nossa diversificação setorial, com
                  processos e transações em setores diversos.');?> </p>
                <div class=" d-flex pt-3 flags">
                  <img src="./assets/images/bandeira-brasil.jpg">
              ...
              <div class="col-4 d-flex align-content-between flex-wrap">
                <div class="row timeline_txt">
                  <div class="col"> <img class="logo_time" src="./assets/images/01.png">
                    ...
                    <p class="pt-1"> <?php echo _('Renato Souza Neto e Paulo Renato Souza, ex-ministro da Educação do Brasil, fundam a
                      Prismapar em 2002 com o objetivo de oferecer consultoria especializada em M&A no setor de Educação
                      no Brasil.');?> </p>
                  </div>
                </div>
        ...
        <div class="row">
          <div class="col-lg-4 col-md-12 mx-auto">
            <div class="texto">
              ...
              <?php echo _('Com sócios em 7 países, conectamos
                clientes nos principais mercados da América Latina.');?> </p>
    ...
    <section id="equipe" class="eqipe-sec py-5">
      <div class="col-lg-8 mx-auto text-center">
        ...
        <div class="col-10 mx-auto my-5">
          <p class="text-white"> <?php echo _('Somos profissionais com ampla experiência em planejamento estratégico e financeiro, com
            passagem pelos maiores bancos e organizações de consultoria estratégica do mundo. Nossa expertise garante um
            profundo conhecimento sobre os mercados da América Latina e conexões dentro de países-chave para a região,
            assegurando atendimento personalizado e assertivo para nossos clientes.');?> </p>
        </div>
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Renato é o idealizador e sócio-fundador da Prismapar. Graduado em
                          Economia pela Universidade George Washington, dos EUA, e com MBA pela INSEAD, da França, tem
                          ampla experiência nas áreas de Fusões e Aquisições, Mercado de Capitais e Relacionamento com
                          Clientes Corporativos, com passagem por grandes organizações mundiais, tais como Banco J.P.
                          Morgan e Egon Zehnder. Baseado em San José, na Costa Rica, atualmente lidera o escritório da
                          Prismapar na Costa Rica, cobrindo toda a região da América Central e do Caribe.');?>  </div>
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Marcelo é sócio-fundador da Prismapar. Possui graduação em
                          Engenharia pela Universidade de Los Andes e em Administração pela Wharton School (UPENN), da
                          Universidade da Pensilvânia, além de MBA pela renomada Universidade de Harvard. Iniciou sua
                          carreira na área de Fusões e Aquisições (M&A) do Deutsche Bank, em Nova York. Também atuou na
                          assessoria de negócios familiares Violy McCausland e foi Diretor Sênior e CFO da Alquería,
                          maior companhia de lácteos da Colômbia. Apaixonado por tecnologia, Marcelo é um dos fundadores
                          da startup INNCUBATED, a primeira incubadora com foco em Educação da América Latina.
                          Atualmente, ele lidera os escritórios da Prismapar na Colômbia e Região Andina.');?>  </div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Oliver é sócio da Prismapar. Formado em Engenharia de Gestão pela
                          Worcester Polytechnic Institute e com MBA pela Babson College, de Massachusetts, Oliver
                          iniciou sua carreira na área de Planejamento Estratégico da Siemens Corporation, em Nova York.
                          Durante sua carreira, ele foi sócio do Grupo Spurrier, empresa líder do setor de consultoria
                          no Equador. Neste período, realizou análises de estudo de concorrência, setoriais, econômicos
                          e de mercado para empresas nacionais e multinacionais, instituições públicas e Organizações
                          Não-governamentais que buscavam posicionar-se no mercado e diversificar seus investimentos.
                          Atualmente, Oliver lidera o escritório da Prismapar no Equador.');?> </div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Bruno é sócio da Prismapar. Graduou-se em Administração pela
                          Faculdade de Economia, Administração e Contabilidade (FEA) da Universidade de São Paulo (USP).
                          Em sua trajetória profissional, Bruno foi Managing Partner na BRN Finance, período em que teve
                          a oportunidade de assessorar acionistas e empresas do Brasil de variados setores. Também fez
                          parte do grupo de Fusões e Aquisições do Banco Rabobank, atuando nos escritórios de São Paulo
                          e, posteriormente, de Nova York. Além disso, Bruno também foi consultor em projetos de Fusões
                          e Aquisições, Planejamento Estratégico, Fairness Opinions e Captação de Recursos na Aggrego
                          Consultores. Antes de integrar a equipe da Prismapar, Bruno participou da fundação da
                          plataforma marketplace Prova.lá. No momento, Bruno lidera o escritório da Prismapar no Brasil.');?> 
                        </div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
                    ...
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Alejandra é sócia da Prismapar com formação em Engenheira Industrial
                          e de Sistemas pelo Instituto Tecnológico de Monterrey, além de ter obtido uma titulação
                          conjunta de Master of Engineering Management (MEM) pela McCormick School of Engineering e
                          Master in Business Adminisration (MBA) na Kellogg School of Management, ambas ligadas à
                          Universidade de Northwestern. Sua experiência profissional contempla uma passagem pela
                          Nacional Monte Piedad, renomada instituição financeira mexicana, onde liderou projetos de
                          Desenvolvimento de Negócios, Inovação e Due Diligence em transações de Fusões e Aquisições de
                          empresas. Também foi gerente de Fusões e Aquisições para América Latina na Laureate Education,
                          um dos maiores grupos de ensino superior do mundo. Atualmente, Alejandra comanda o escritório
                          da Prismapar na Cidade do México.');?> </div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Ana é associada na Prismapar. Graduada em Ciências Econômicas pela
                          Universidade Federal de Ouro Preto e em Ciências Contábeis pela PUC-Minas Gerais, ela também
                          possui pós-graduação em Finanças Aplicadas pela PUC-Minas Gerais. Durante sua carreira, Ana
                          atuou nas áreas de consultoria financeira e auditoria nas empresas multinacionais Hindalco e
                          Price Waterhouse Coopers (PwC). Antes de ingressar na Prismapar, ela também trabalhou no
                          departamento de Fusões e Aquisições do Grupo Zelo, um dos maiores grupos consolidadores do
                          setor de serviços funerários do Brasil. Ana integra a equipe do escritório da Prismapar no
                          Brasil.');?> </div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-cargo ">
                          <h5> <?php echo _('Sócio Consultor');?> Sócio Consultor</h5>
                        </div>
                        <div class="modal-detalle "> <?php echo _('Andrés é sócio-consultor da Prismapar. Formado em Economia e
                          Ciências Humanas pela Pontifícia Universidade Católica do Peru, estudou finanças na
                          Universidade ESAN, em Lima, e obteve seu MBA na IESE Business School, de Madri. Executivo com
                          ampla experiência internacional em cargos diretivos, trabalhou em diversas funções executivas
                          dentro do Grupo Prisa, maior conglomerado de comunicação da Espanha. Também foi líder na
                          expansão do Grupo Santillana na América Latina. Atualmente, além de participar do conselho de
                          diversas empresas na Europa e na América Latina, Andrés é diretor do escritório da Prismapar
                          em Madri, na Espanha.');?> </div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Hilario é sócio-consultor da Prismapar. Formado em Direito pela
                          Universidade Complutense de Madri, ele obteve seu MBA pela EU Business School, da Suíça. Ao
                          longo de sua carreira, Hilario atuou como consultor independente e associado para bancos de
                          investimento prestando assessoria para acionistas e empresas da América Latina nos setores
                          financeiro, agroindustrial, energia, educação e farmacêutico, entre outros. Também foi
                          co-diretor de Fusões e Aquisições do UBS, em Nova York, aconselhando também grupos familiares
                          na América Latina. Além disso, Hilario atuou como diretor e membro do Conselho da SISCO na
                          América
                          Central, onde teve a oportunidade de executar diversos projetos. Hoje, Hilario é diretor do
                          escritório da Prismapar em Nova York.');?> </div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Daniel é sócio-consultor da Prismapar, onde iniciou sua carreira
                          como analista. Ele é formado em Administração de Empresas pelo Instituto de Ensino e Pesquisa
                          (INSPER), do Brasil. Em sua trajetória profissional, Daniel trabalhou na divisão de
                          Investimentos do Unibanco, atuando na área de Mercado de Capitais e Fusões e Aquisições.
                          Também foi colaborador na GP Investimentos/BRZ Investimentos, atuando na análise de novos
                          projetos, monitoramento de portfólio e relação com investidores de fundos. Atualmente, ele
                          colabora em projetos específicos da Prismapar no Brasil.');?> </div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
                  ...
                  <div class="container-fluid ">
                    <div class="row">
                      <div class="col-sm-8">
                        ...
                        <div class="modal-detalle "> <?php echo _('Nicolas se formou com honras em Engenharia Industrial e Administração de
                          Empresas pela Universidad de los Andes. Antes de se juntar à Prismapar,
                          trabalhou na Universidad de los Andes no desenvolvimento de um livro sobre a
                          criação de unicórnios em mercados emergentes. Além disso, participou de um
                          projeto de consultoria, da mesma universidade, para auxiliar o JEP, na

                          Colômbia, no processamento de informações para a criação de Macrocases.
                          Atualmente, faz parte da equipe Prismapar na Região Andina.');?></div>
                        <div class="row modal-redes">
                          <div class="col-8 contato-modal">
        ...
        <div class="mx-auto my-5">
          <div class="row mx-auto">
            <div class="col-lg mx-auto">
              ...
              <p class="text-justify"> <?php echo _('Somos especializados em Fusões e Aquisições (M&A), Levantamento de Recursos e
                Venture Investing e focados em transações cross-border nos principais mercados da América Latina.');?> </p>
              <p class="text-justify">
              <?php echo _('Auxiliamos nossos clientes a planejar e executar seus movimentos mais estratégicos de compra, venda,
                diversificação e readequação de portfólio de produtos, tecnologias e mercados.');?> </p>
              <p class="text-justify">
              <?php echo _('Atuamos em todas as etapas do processo');?> </p>
              <p class="text-justify"> <?php echo _('1) Diagnóstico da situação inicial da empresa, dos acionistas e do mercado,
                identificando riscos e oportunidades envolvidos na transação');?> </p>
              <p class="text-justify"> <?php echo _('2) Planejamento e preparação do processo mais indicado, incluindo a preparação de
                materiais e o mapeamento de potenciais contrapartes, compradoras ou vendedoras');?> </p>

            </div>

            <div class="col-lg mx-auto">

              <p class="text-justify"> <?php echo _('3) Apresentação da oportunidade às contrapartes, recebimento ou elaboração de
                ofertas, negociação de termos e estrutura da transação');?>  </p>
              <p class="text-justify"> <?php echo _('4) Suporte ao processo de diligência e negociação de termos e contratos finais,
                até o fechamento e anúncio da transação');?> </p>
    ...
    <section class="location-banner" style="background-image: url(./assets/images/banner_5.jpg); background-position: center; background-size: cover; background-repeat: no-repeat;">
      <div class="col-lg-8 mx-auto">
        <div class="bottom-left1 text-white"> <?php echo _('Nova York - World Trade Center
          Transportation Hub');?>  </div>
      </div>
    </section>
          ...
          <div class="owl-carousel owl-carousel1 owl-theme owl-loaded owl-drag">
            <div class="row content">
              <div class="col-lg-6 case_content">
                ...
                <p> <?php echo _('Fomos os assessores exclusivos na venda dos ativos de arroz e logística do Grupo Dajahu S.A., do
                  Equador, para a brasileira Camil Alimentos S.A., uma das maiores empresas do setor de alimentos da
                  América Latina.');?>  </p>

                <p> <?php echo _('Atuamos em todas as etapas dessa transação, desde a preparação do processo e a aproximação das
                  partes, passando pela negociação dos termos e estrutura e pela coordenação da diligência, até a
                  concretização do negócio, que movimentou cerca de US$ 36,5 milhões.');?> </p>

                <p> <?php echo _('O Grupo Dajahu é uma das maiores organizações do Equador e atua nos ramos imobiliário, logístico
                  e de alimentos, sendo líder no mercado de arroz do país. A venda dos ativos estava alinhada à
                  estratégia do Grupo e permitiu novos investimentos nos setores imobiliário e logístico.');?>  </p>
            ...
            <div class="row content">
              <div class="col-lg-6 case_content">
                ...
                <p class="lead"> </p>
                <p> </p>
                <p><?php echo _('Atuamos na assessoria estratégica, financeira e operacional do Fundo de Investimentos Advent
                  International na aquisição de ativos das redes de ensino brasileiras Kroton Educacional e IUNI
                  Educacional.');?>  </p>

                <p> <?php echo _('Nossa equipe participou da concepção estratégica junto ao cliente, que tinha como objetivo
                  ingressar no mercado de Ensino Superior do Brasil por meio de uma plataforma de forte crescimento.
                  Atuamos também na busca e abordagem dos ativos promissores e em todas as etapas das aquisições,
                  desde a preparação até o fechamento das transações que movimentaram cerca de US$ 247 milhões.');?> </p>

                <p> <?php echo _('O sucesso das operações deu origem a maior organização educacional do Brasil e uma das maiores do
                  mundo, a Cogna Educacional, com cerca de 2,4 milhões de estudantes.');?> 
                </p>
      ...
      <div class="row mx-auto footer">
        <div class="col-lg-6 px-0">
          <ul class="px-0 mt-4 pt-4" style="list-style-type: none;">
            ...
            <li><a href="#numeros" style="text-decoration: none;" class="text-white"> <?php echo _('PRISMAPAR EM
                NÚMEROS');?></a> </li>
          </ul>
        </div>
        <div class="col-lg-6 px-0">
